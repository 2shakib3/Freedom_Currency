                          ...
                          <ul class="list-unstyled list mb-0">
                            <li class="py-2 mb-1 border-bottom">
                              <a href="javascript:void(0);" class="d-flex">
                                <img
                                  ...
                                  src="{{ asset ('backend/assets/images/xs/avatar1.svg') }}"
                                  alt=""
                                />
                            ...
                            <li class="py-2 mb-1 border-bottom">
                              <a href="javascript:void(0);" class="d-flex">
                                <img
                                  class="avatar rounded-circle"
                                  src="{{ asset ('backend/assets/images/xs/avatar3.svg') }}"
                                  alt=""
                                />
                                <div class="flex-fill ms-2">
                                  <p
                            ...
                            <li class="py-2 mb-1 border-bottom">
                              <a href="javascript:void(0);" class="d-flex">
                                <img
                                  class="avatar rounded-circle"
                                  src="{{ asset ('backend/assets/images/xs/avatar5.svg') }}"
                                  alt=""
                                />
                                <div class="flex-fill ms-2">
                                  <p
                            ...
                            <li class="py-2 mb-1 border-bottom">
                              <a href="javascript:void(0);" class="d-flex">
                                <img
                                  class="avatar rounded-circle"
                                  src="{{ asset ('backend/assets/images/xs/avatar6.svg') }}"
                                  alt=""
                                />
                                <div class="flex-fill ms-2">
                                  <p
                            ...
                            <li class="py-2">
                              <a href="javascript:void(0);" class="d-flex">
                                <img
                                  class="avatar rounded-circle"
                                  src="{{ asset ('backend/assets/images/xs/avatar7.svg') }}"
                                  alt=""
                                />
                                <div class="flex-fill ms-2">
                                  <p
                ...
                >
                  ...
                  >
                    <img
                      ...
                      src="{{ asset ('backend/assets/images/profile_av.svg') }}"
                      alt="profile"
                    />
                  </a>
                  <div
                ...
                >
                  <marquee>
                    <p
                      ...
                      "
                    >
                      Welcome To Freedom Currency Dashboard
                    </p>
                  </marquee>
                </div>
              </div>
