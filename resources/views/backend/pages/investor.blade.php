...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <table id="dtBasciExample"  class="table table-bordered table-responsive dataTable mdl-data-table" >
                    <thead>
                      <tr>
                ...
                <tbody>
                  <tr>
                    @foreach ($investors as $investor)
                        ...
                        <td>
                            @if (Carbon\carbon::now()<=$investor->validity)
                            <p>Approved</p>
                            @else
                                Expired
