                            ...
                            <nav aria-label="breadcrumb ">
                                <ol class="breadcrumb purple lighten-4">
                                    <li class="breadcrumb-items">
                                        <a class="black-text" href="#">Home</a><i class="ti-angle-right"
                                            aria-hidden="true"></i>
                                    </li>
                                    <li class="breadcrumb-items">
                                        <a class="black-text" href="#">User Investment </a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <aside class="sidebar">
                        <div class="dashboard-side">
                            ...
                            <div class="dashboard-menu">
                                <ul>
                                    <li>
                                        <a href="user-panel.html"><i class="ti-dashboard"></i>Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="user-deposit.html"><i class="ti-wallet"></i>Deposit Money</a>
                                    </li>
                                    <li>
                                        <a href="user-withdraw.html"><i class="ti-import"></i>Withdraw Money</a>
                                    </li>
                                    <li class="active">
                                        <a href="user-invest.html"><i class="ti-new-window"></i>Total Investment</a>
                                    </li>
                                    <li>
                                        <a href="user-transection.html"><i class="ti-layout-list-thumb"></i>Transection</a>
                                    </li>
                                    <li>
                                        <a href="user-notifecations.html"><i class="ti-bell"></i>Notifecations</a>
                                    </li>
                                    <li>
                                        <a href="user-info.html"><i class="ti-settings"></i>Settings</a>
                                    </li>
                                    <li>
